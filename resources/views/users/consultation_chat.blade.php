    ...
    <div class="content">
        <section>
            <div class="container">
                <div class="chat-box">
                    <div class="image">
                        <img src="{{ filter_var(Auth::user()->avatar, FILTER_VALIDATE_URL) ? Auth::user()->avatar : Voyager::image(Auth::user()->avatar) }}"
                            alt="">
                    ...
                    <div class="box-cont">
                        ...
                        <div class="text-cont">
                            ...
                            <form class="send" method="POST" action="{{ url('users/consultation/chat/store') }}">
                                ...
                                <button type="submit" name="id" value="{{ $id }}"><img src="{{ asset('img/Fill 2.png') }}" alt=""></button>
                            </form>
                        </div>
                    </div>
                </div>
