...
<html dir="rtl" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="background-color: rgb(236, 236, 236)">
        <div class="tr">
            <div class="header">
                <div class="header-container">
                    <div class="card">
                        <a href="">
                            <img src="{{asset('img/mostafa-medium-3.png')}}" alt="">
                        </a>
                    </div>
                    
                    <div class="card">
                        <a href="">
                            <img src="{{asset('img/shimaa-medium-3.png')}}" alt="">
                        </a>
                    </div>

                    <div class="card">
                        <a href="">
                            <img  src="{{asset('img/reda-medium-3.png')}}" alt="">
                        </a>
                    </div>
                    ...
                    {{-- <div class="card>
                        <img width="300px" src="{{asset('img/shimaa-medium-3.png')}}" alt="">
                    </div> --}}
                    {{-- <div class="card" style="background-color: rgba(255, 255, 255, 0)">
                        <img  src="" alt="">
                    </div> --}}
                    <div class="card">
                        <a href="">
                            <img  src="{{asset('img/nahla-medium-3.png')}}" alt="">
                        </a>
                    </div>
                    <div class="card">
                        <a href="">
                            <img  src="{{asset('img/ibrahim-medium-3.png')}}" alt="">
                        </a>
                    </div>
